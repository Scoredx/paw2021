...
export class Notes{
    ...
    createNote(note: INote){
        ...
        let noteDateBanner: HTMLDivElement = document.createElement("div");
        noteDateBanner.id = "noteDrag" + app.counter;
        noteDateBanner.className = "noteDrag";
        ...
        noteDiv.appendChild(noteDateBanner);
        noteDateBanner.appendChild(noteDate);
